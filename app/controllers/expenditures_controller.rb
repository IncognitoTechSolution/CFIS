class ExpendituresController < ApplicationController
  ...
  private
    ...
    def expenditure_params
      params.require(:expenditure).permit(:campaign_finance_info_id, :expend_type_id, :expend_category_id, :payment_method_id, :prefix_id, :entity_type_id, :contributorname, :address, :city, :state_id, :zip, :amount, :date, :description, :isbenefitCOH, :istraveloutsidetx, :isreimbursementintended)
    end
end
