class CohPaymentsController < ApplicationController
  ...
  private
    ...
    def coh_payment_params
      params.require(:coh_payment).permit(:campaign_finance_info_id, :expend_category_id, :prefix_id, :entity_type_id, :businessname, :address, :city, :state_id, :zip, :amount, :date, :description, :isbenefitcoh, :istraveloutsidetx, :isaustintxlivingexpense)
    end
end
