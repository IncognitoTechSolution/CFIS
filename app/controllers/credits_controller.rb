class CreditsController < ApplicationController
  ...
  private
    ...
    def credit_params
      params.require(:credit).permit(:campaign_finance_info_id, :prefix_id, :entity_type_id, :creditorname, :address, :city, :state_id, :zip, :amount, :date, :purpose, :isreturnedtofiler)
    end
end
