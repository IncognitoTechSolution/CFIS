class FilersController < ApplicationController
  ...
  private
    ...
    def filer_params
      params.require(:filer).permit(:filer_type_id, :firstname, :mi, :lastname, :committeename, :phone, :extension, :releasepassword, :releasepasswordto, :emailpasswordto, :signature, :office_held_id, :office_sought_id)
    end
end
