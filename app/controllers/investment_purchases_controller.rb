class InvestmentPurchasesController < ApplicationController
  ...
  private
    ...
    def investment_purchase_params
      params.require(:investment_purchase).permit(:campaign_finance_info_id, :prefix_id, :entity_type_id, :investorname, :address, :city, :state_id, :zip, :amount, :date, :description)
    end
end
