class TravelsController < ApplicationController
  ...
  private
    ...
    def travel_params
      params.require(:travel).permit(:campaign_finance_info_id, :name, :form_type_id, :travelbegin, :travelend, :prefix_id, :travelername, :departureloc, :destinationloc, :transportation, :purpose)
    end
end
